...
def compute_all_losses(model, batch_dict):
	...
	pred_y = model.forecasting(batch_dict["observed_tp"], batch_dict["observed_data"], batch_dict["observed_mask"],
							batch_dict["tp_to_predict"], batch_dict["data_to_predict"], batch_dict["mask_predicted_data"],) 
